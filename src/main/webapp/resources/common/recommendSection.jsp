  ...
  <div class="container">
    ...
    <div class="row position-relative">
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <span class="colored-box text-center h3 mb-4">9
              <p class="month">Jan</p>
            </span>
            <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
              <h4 class="h5 mb-1">수락산</h4>
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <span class="colored-box text-center h3 mb-4">17
              <p class="month">Mar</p>
            </span>
            <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
              <h4 class="h5 mb-1">수락산</h4>
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <span class="colored-box text-center h3 mb-4">25
              <p class="month">Apr</p>
            </span>
            <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
              <h4 class="h5 mb-1">수락산</h4>
